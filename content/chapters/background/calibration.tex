...
If everything (objects in the picture, distances between objects and pixel size and focal length of the cameras) is scaled by a factor $k$, then the resulting images do not change.
