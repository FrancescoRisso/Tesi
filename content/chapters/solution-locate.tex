...
Its \texttt{locate} function performs the task required, if an extra ouptut format transformation step is applied.

\subsubsection{Algorithm}

As described in the documentation, the \texttt{locate} function implements the following algorihtm:
\begin{enumerate}
	\itemsep 0em
	\item Preprocess the image by performing a band pass and a threshold.
