...
\begin{\structuretype}
	...
	\structureitem{\ref{chap:locate}}{deeply analyses the requirements, the alternatives and the final implementation for the \textit{Locate} step of the algorithm;}
	\structureitem{\ref{chap:2dlink}}{performs a similar analysis for the \textit{2D Link} step;}
	\structureitem{\ref{chap:matching}}{examines in a similar way the approaches for \textit{3D matching};}
	\structureitem{\ref{chap:3dlink}}{describes the \textit{3D Link} alternatives, in contrast to the 2D ones explained in chapter \ref{chap:2dlink};}
